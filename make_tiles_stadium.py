...
TILES = [
    ('stadium-zoning.png',  'stadium', 'Stadiums',   'zoning by venue'),
    ('stadium-arenas.png',  'ring',    'Arenas',     'the big five'),
    ('stadium-ballparks.png','dots',   'Ballparks',  'and courts'),
    ('stadium-jia.png',     'boro',    'Joint Areas','no single board'),
]
