...
},
{
 ...
 'desc':'Park Slope Food Coop at 782 Union Street. A member-owned and member-run grocery since 1973: hours, how it works, the monthly General Meeting, and the lot it stands on.',
 'lat':'40.674738','lng':'-73.976816',
 'addr':'782 Union Street','zip':'11215',
 'addr_note':'Between Sixth and Seventh Avenues. The city files the lot as 780 Union Street',
 'phone':'718-622-0560','tel':'7186220560',
 'email':'',
 'web':'foodcoop.com','weburl':'https://www.foodcoop.com',
 'since':'',
 'intro':[
   'The <b>Park Slope Food Coop</b> has been at 782 Union Street since 1973. Members own the store and run it: every member works a shift, only members shop, and the labor is what keeps the prices down. The monthly General Meeting, open to every member with a vote for everyone who shows up, has been the decision-making body from the start.',
   'The Coop is one of the oldest and largest member-run food cooperatives in the country, and it is a Park Slope institution in the plainest sense: a two storey building on a residential block that thousands of households pass through every week.',
 ],
 'does_title':'How the Coop works',
 'does':[
   'The Coop is a <b>member-owned and operated food store</b>. Membership is open to all, only members may shop, and members contribute their labor on recurring work shifts, sharing the responsibilities and the benefits equally. The store buys as an agent for its members, with an emphasis on organic, minimally processed food and local, earth-friendly producers.',
   'The <b>General Meeting</b> is held on the last Tuesday of each month at 7 PM. The agenda, with the location and how to attend, is posted inside the Coop and online about three weeks ahead. The Board of Directors is elected at the <b>Annual Meeting</b> in June.',
   'The building at <b>782 Union Street</b> is a two storey store built in 1920 on a 7,980 square foot lot, owned by the Coop itself. The lot is zoned <b>R6A</b>.',
 ],
 'kv':[('Shopping hours','Mon to Sat 8 AM to 9 PM<br>Sun 8 AM to 8 PM'),
       ('Office hours','Mon, Tue 10:30 AM to 5:30 PM<br>Wed closed<br>Thu to Sat 10:30 AM to 5:30 PM<br>Sun 8 AM to 3:30 PM'),
       ('Fax','718-622-5685'),
       ('Community board','<a href="/cb-bk-6.html">Brooklyn Community Board 6</a>'),
       ('Zoning','R6A')],
 'brand':{'dark':'#4c6028','mid':'#6b7f3c','light':'#b7c48f','wash':'#f1f3e8','accent':'#1a1a1a','ink':'#3b4b1f'},
 'evorg':'psfc','evtitle':'Coming up at the Park Slope Food Coop','evhref':'/o/psfc.html','evname':'The Park Slope Food Coop calendar',
 'does_btns':[('Hours and location','https://www.foodcoop.com/hours',True),
              ('General Meeting agenda','https://www.foodcoop.com/gmagenda',True),
              ('What is coming up','/o/psfc.html',False),
              ('Zoning and land use for the lot','/citywide-search.html?address=782%20Union%20Street%2C%20Brooklyn',False)],
 'links':[('Their site','https://www.foodcoop.com',True),
          ('The Linewaiters&rsquo; Gazette','https://linewaitersgazette.com',True),
          ('Their calendar','/o/psfc.html',False),
          ('Search an address','/citywide-search.html',False)],
},
{
 'slug':'artsgowanus',
 'unsigned':True,
 'name':'Arts Gowanus',
 'seat':'Community based arts organisation &middot; Gowanus, Brooklyn',
 'title':'Arts Gowanus',
 'desc':'Arts Gowanus at 543 Union Street in Gowanus. Gowanus Open Studios, art programming, the Arts Gowanus Fellowship, and advocacy for affordable artist studios in the Gowanus rezoning.',
 'lat':'40.679396','lng':'-73.987502',
 'addr':'543 Union Street, Studio 2B','zip':'11215',
 'phone':'848-225-7217','tel':'8482257217',
 'email':'info@artsgowanus.org',
 'web':'artsgowanus.org','weburl':'https://www.artsgowanus.org',
 'since':'1996',
 'intro':[
   '<b>Arts Gowanus</b> has worked for the artists of Gowanus since <b>1996</b>. In the words of its own mission, Arts Gowanus nurtures a diverse, inclusive creative community that welcomes all artists in the neighborhood, creating new spaces for art to bring people together, build a more vibrant community, and uplift the greater Gowanus area.',
   'Arts Gowanus runs <b>Gowanus Open Studios</b>, which it calls Brooklyn&rsquo;s largest celebration of local art, with more than 400 artists, businesses and venues opening their doors from Pacific Street to 19th Street and from Smith Street to Fifth Avenue. The 30th annual Open Studios is <b>October 17 and 18, 2026</b>.',
   'Executive Director <b>Johnny Thornton</b> leads the organisation.',
 ],
 'does_title':'What Arts Gowanus does',
 'does':[
   'Arts Gowanus runs <b>art programming and partnerships</b> that raise the visibility of Gowanus artists across the city, the <b>Arts Gowanus Fellowship</b>, which covers a selected artist&rsquo;s studio rent, and <b>curatorial services</b>.',
   'On the <b>Gowanus rezoning</b>, Arts Gowanus negotiated a Community Benefits Agreement that secures roughly <b>120 subsidized artist studios</b> across the development sites, starting at $20 a square foot a year, with one studio in each building reserved for a low income artist. The agreement also secures a <b>2,000 square foot community arts center</b> with three residency studios, affordable in perpetuity.',
   'Arts Gowanus works alongside the Gowanus Neighborhood Coalition for Justice, the Gowanus Oversight Task Force, GRACE and the Gowanus Improvement District. The office at <b>543 Union Street</b> is zoned <b>M1-4/R7-2</b> inside the <b>Gowanus special district</b>.',
 ],
 'kv':[('Founded','1996'),('Executive Director','Johnny Thornton'),
       ('Community board','<a href="/cb-bk-6.html">Brooklyn Community Board 6</a>'),
 ...
 'does_btns':[('Gowanus Open Studios','https://www.artsgowanus.org/gowanus-open-studios',True),
              ...
              ('What is coming up','/o/artsgowanus.html',False),
              ('Zoning and land use for the lot','/citywide-search.html?address=543%20Union%20Street%2C%20Brooklyn',False)],
 'extra':[('The rezoning and the Task Force',
           [('The Gowanus rezoning','/gowanus.html',False),
            ('Gowanus Oversight Task Force','https://gowanustaskforce.net/',True),
            ('Task Force meetings on the calendar','/o/gotf.html',False)])],
 'links':[('Their site','https://www.artsgowanus.org',True),
          ('Instagram','https://www.instagram.com/artsgowanus/',True),
          ('Their calendar','/o/artsgowanus.html',False),
          ('Search an address','/citywide-search.html',False)],
},
{
...
for o in ORGS:
    ...
    if o.get('flyer'):
        f = o['flyer']
        flyer = ('  <div class="sec flyersec" id="orgFlyer" data-until="%s"><a href="%s" style="display:block">'
