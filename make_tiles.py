...
TILES = [
    ('311-hub.png',        'grid',    '311 Hub',      'start here'),
    ('311-citywide.png',   'ring',    'Citywide',     'all 59 districts'),
    ('311-compare.png',    'bars',    'Compare',      'rank all 59'),
    ('311-district.png',   'dots',    'One District', 'every complaint'),
    ('311-boroughs.png',   'boro',    'Boroughs',     'five ways in'),
    ('311-find.png',       'pin',     'Find Mine',    'address or pin'),
    ('311-stadiums.png',   'stadium', 'Stadiums',     'zoning by venue'),
]
