...
TILES = [
    ('venue-madison-square-garden.png', 'stadium', 'The Garden', 'knicks · rangers'),
    ('venue-barclays-center.png', 'ring', 'Barclays', 'nets · liberty'),
    ('venue-yankee-stadium.png', 'dots', 'Yankee Stadium', 'yankees'),
    ('venue-citi-field.png', 'boro', 'Citi Field', 'mets'),
    ('venue-etihad-park.png', 'bars', 'Etihad Park', 'nycfc'),
    ('venue-usta-tennis-center.png', 'pin', 'USTA Center', 'us open'),
    ('venue-forest-hills-stadium.png', 'stadium', 'Forest Hills', 'concerts'),
    ('venue-maimonides-park.png', 'dots', 'Maimonides', 'cyclones'),
    ('venue-siuh-community-park.png', 'bars', 'SIUH Park', 'ferryhawks'),
    ('venue-icahn-stadium.png', 'ring', 'Icahn Stadium', 'track & field'),
]
