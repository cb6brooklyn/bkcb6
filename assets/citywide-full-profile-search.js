(function(){
  ...
  function landUseHero(code){
    ...
    return '<div style="flex:1;min-width:0;background:#f47920;border-radius:7px;padding:11px 13px;align-self:stretch">'
      + '<div style="font-family:\'DM Mono\',monospace;font-size:.6rem;text-transform:uppercase;letter-spacing:.1em;color:#0d1b4b;font-weight:700">land use</div>'
      + '<div style="font-size:1.05rem;font-weight:900;line-height:1.18;color:#fff;margin-top:3px;word-break:normal;overflow-wrap:break-word;hyphens:auto">'+esc(name)+'</div>'
      + (ugTxt?'<div style="font-family:\'DM Mono\',monospace;font-size:.66rem;color:rgba(255,255,255,.9);margin-top:5px">'+esc(ugTxt)+'</div>':'')
      + '</div>';
  }
