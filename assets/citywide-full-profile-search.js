(function(){
  ...
  async function fetchZoningByPoint(lat,lng){
    ...
    try{
      var env={xmin:lng-0.00008,ymin:lat-0.00008,xmax:lng+0.00008,ymax:lat+0.00008,spatialReference:{wkid:4326}};
      var url='https://services5.arcgis.com/GfwWNkhOj9bNBqoJ/arcgis/rest/services/nyzd/FeatureServer/0/query?where=1%3D1&outFields=ZONEDIST&returnGeometry=false&outSR=4326&geometry='+encodeURIComponent(JSON.stringify({x:lng,y:lat,spatialReference:{wkid:4326}}))+'&geometryType=esriGeometryPoint&inSR=4326&spatialRel=esriSpatialRelIntersects&f=json&resultRecordCount=10';
