(function(){
  ...
  var OWNER_NOTE={
    '30 LAFAYETTE AVE':'The lot is recorded to the Department of Parks and Recreation. BAM is one of the city\'s Cultural Institutions Group members, which sit on city owned land and in city owned buildings while being run by independent nonprofits. The city holds the property, the institution runs the programming.',
    '651 FULTON ST':'The lot is recorded to the Department of Cultural Affairs. BAM is a Cultural Institutions Group member, so the building is city owned and the nonprofit operates it under an agreement with the city.',
    '653 FULTON ST':'The lot is recorded to the Department of Cultural Affairs. BAM is a Cultural Institutions Group member, so the building is city owned and the nonprofit operates it under an agreement with the city.',
    '321 ASHLAND PL':'The lot is recorded to the Department of Cultural Affairs. BAM is a Cultural Institutions Group member, so the building is city owned and the nonprofit operates it under an agreement with the city.',
